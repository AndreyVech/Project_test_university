...
public class XlsxWriteSheet1 {
    XlsxWriteSheet1(XSSFWorkbook createdBook, List<Student> students, List<University> universities) {
        XSSFSheet createdSheet = createdBook.createSheet("Главный");
//        здесь готовим коллекцию для статистики
        List<Statistics> dataList = createStatList1(students, universities);
        int rowNum = 0;
